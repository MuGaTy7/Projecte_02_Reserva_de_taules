...
<body>
    ...
    <div class="region-navbar">
        <nav class="widget-navbar">
            <ul>
                <li><a id="btn_salon">Salón</a></li>
                <li><a id="btn_terraza">Terraza</a></li>
                <li><a id="btn_privada_1">Sala Privada 1</a></li>
                <li><a id="btn_privada_2">Sala Privada 2</a></li>
    ...
    <div class="region-rest">
        <div class="widget-rest" id="widget_resultado">
