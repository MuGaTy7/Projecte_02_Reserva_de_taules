...
$contenido_mantenimiento = [
    "form" => "<div>
        <h3 id='titleRegister' class='text-center'>Registro de mantenimiento</h3>
    </div>
    <div class='card-body'>
    ...
    "mantenimiento" => "<div class='buscador-table'>
    <form action='' method='post' id='frmbusqueda'>
        <div class='form-group'>
            <label for='buscra'>FILTROS DE MANTENIMIENTO:</label>
            <div class='div-filtros'>
                <input type='text' name='buscar_id' id='buscar_id' placeholder='ID Mantenimiento' class='form-control'>
...
echo json_encode($contenido_mantenimiento);
